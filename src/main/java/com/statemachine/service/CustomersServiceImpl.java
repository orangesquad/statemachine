...
public class CustomersServiceImpl implements CustomersService {
	...
	public CusotmersResponseDto createAccount(CustomerCreateRequestDto customerCreateRequestDto)
			throws CustomerMobileNumberNotFoundException, CustomerEmailNotFoundException, CustomerNameNotFoundException,
		...
		if (customerCreateRequestDto.getAddress().equals(null)
				|| customerCreateRequestDto.getAddress().trim().equals("")) {
